    ...
    class ScoreCard
    {
        ...
        public void ShowDetails()
        {
            ...
            for (int i = 0; i < students.Length; i++)
            {
                ...
                if (avg >= 50)
                {
                    Console.WriteLine($"{students[i].RollNo}  {students[i].Name} have cleared the exam");
                }
        ...
        public void score()
        {
            for (int i = 0; i < students.Length; i++)
            {
                ...
                {
                    Console.WriteLine($"student of name:{students[i].Name} rollnumber:{students[i].RollNo} have to reappear the exam");
                }
                else
                {
